...
@with_kw struct Params
    ...
    β::Float64 = 13.0 # [-] Initial interface position
    ...
    Lx::Float64 = 15.0 # [-] Spatial domain limit (x)
    Ly::Float64 = 5.0 # [-] Spatial domain limit (y)
    T::Float64 = 10.0 # [-] End time
    Nx::Int = 601 # [-] Number of grid points (x)
...
function fisher_stefan_2d()
    ...
    par = Params(q = 4*π/10) # Initialise data structure of model parameters
